...
// Possible states for zCOLX send
...
public:
    ...
    */
    ...
    bool GetBudgetSystemCollateralTX(CTransaction& tx, uint256 hash, int nBudgetBlockStart, bool useIX);
    bool GetBudgetSystemCollateralTX(CWalletTx& tx, uint256 hash, int nBudgetBlockStart, bool useIX);
