...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ColossusXT address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCOLX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ColossusXT Core"), this);
    aboutAction->setStatusTip(tr("Show information about ColossusXT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ColossusXT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ColossusXT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ColossusXT addresses"));
    ...
    openAction->setStatusTip(tr("Open a ColossusXT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ColossusXT Core help message to get a list with possible ColossusXT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ColossusXT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ColossusXT network", "", count));
}
...
{
    QString strTitle = tr("ColossusXT Core"); // default title
