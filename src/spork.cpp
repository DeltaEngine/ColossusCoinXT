...
// COLX: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_FEE_PAYMENT_ENFORCEMENT) r = SPORK_17_FEE_PAYMENT_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT) r = SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_FEE_PAYMENT_ENFORCEMENT") return SPORK_17_FEE_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT") return SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_FEE_PAYMENT_ENFORCEMENT) return "SPORK_17_FEE_PAYMENT_ENFORCEMENT";
    if (id == SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT) return "SPORK_18_DEVFUND_PAYMENT_ENFORCEMENT";
