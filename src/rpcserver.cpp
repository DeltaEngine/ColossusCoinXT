...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"colx", "listmasternodes", &listmasternodes, true, true, false},
        {"colx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"colx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"colx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"colx", "masternodedebug", &masternodedebug, true, true, false},
        {"colx", "startmasternode", &startmasternode, true, true, false},
        {"colx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"colx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"colx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"colx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"colx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"colx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"colx", "initmasternode", &initmasternode, true, true, false},
        {"colx", "masternodeisinit", &masternodeisinit, true, true, false},
        {"colx", "killmasternode", &killmasternode, true, true, false},
        {"colx", "mnbudget", &mnbudget, true, true, false},
        {"colx", "preparebudget", &preparebudget, true, true, false},
        {"colx", "submitbudget", &submitbudget, true, true, false},
        {"colx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"colx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"colx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"colx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"colx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"colx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"colx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"colx", "checkbudgets", &checkbudgets, true, true, false},
